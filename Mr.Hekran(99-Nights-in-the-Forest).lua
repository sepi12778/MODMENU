local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/sepi12778/MODMENU/refs/heads/main/Mr.Hekran%5Bset%5D(99-Nights-in-the-Forest).lua'))()
...
local Window = Rayfield:CreateWindow({
    Name = "99 Nights",
    LoadingTitle = "Mr.Hekran 99 Nights v[2.690.721]",
    LoadingSubtitle = "by Mr.Hekran",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = nil,
